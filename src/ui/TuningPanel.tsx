...
export default function TuningPanel() {
  ...
  useControls(
    'mundo',
    {
      ...
      'volcadura: fundido (s)': {
        value: balance.rescate.volcadura.pausaSegundos,
        min: 0.5,
        max: 10,
        step: 0.5,
        onChange: (n: number) => void (balance.rescate.volcadura.pausaSegundos = n),
      },
      'volcadura: derrame mín': {
        value: balance.rescate.volcadura.derrameMin,
        min: 0,
        max: 1,
        step: 0.05,
        onChange: (n: number) => void (balance.rescate.volcadura.derrameMin = n),
      },
      'volcadura: derrame máx': {
        value: balance.rescate.volcadura.derrameMax,
        min: 0,
        max: 1,
        step: 0.05,
        onChange: (n: number) => void (balance.rescate.volcadura.derrameMax = n),
      },
      'volcadura: umbral up': {
        value: tuning.vuelco.upY,
        min: -0.5,
        max: 0.9,
        step: 0.05,
        onChange: (n: number) => void (tuning.vuelco.upY = n),
      },
      'volcadura: sostenida (s)': {
        value: tuning.vuelco.segundos,
        min: 0.5,
        max: 6,
        step: 0.5,
        onChange: (n: number) => void (tuning.vuelco.segundos = n),
      },
      'efímeros máx': {
        value: balance.efimeros.maxActivos,
        min: 0,
        max: 6,
        step: 1,
        onChange: (n: number) => void (balance.efimeros.maxActivos = n),
      },
      'efímero aparece mín (s)': {
        value: balance.efimeros.spawnMin,
        min: 5,
        max: 120,
        step: 5,
        onChange: (n: number) => void (balance.efimeros.spawnMin = n),
      },
      'efímero aparece máx (s)': {
        value: balance.efimeros.spawnMax,
        min: 10,
        max: 240,
        step: 5,
        onChange: (n: number) => void (balance.efimeros.spawnMax = n),
      },
      'efímero vida mín (min)': {
        value: balance.efimeros.vidaMin,
        min: 0.5,
        max: 10,
        step: 0.5,
        onChange: (n: number) => void (balance.efimeros.vidaMin = n),
      },
      'efímero vida máx (min)': {
        value: balance.efimeros.vidaMax,
        min: 1,
        max: 15,
        step: 0.5,
        onChange: (n: number) => void (balance.efimeros.vidaMax = n),
      },
    },
    CERRADA,
  )
